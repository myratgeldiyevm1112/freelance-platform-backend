...
class TestGetAllUsers:
    ...
    @pytest.mark.asyncio
    async def test_get_all_users_multiple(self):
...
class TestGetPlatformStats:
    ...
    @pytest.mark.asyncio
    async def test_get_stats_handles_none_values(self):
        db = make_db_mock()
    ...
    @pytest.mark.asyncio
    async def test_get_stats_calls_db_seven_times(self):
        db = make_db_mock()
...
class TestGetAllJobs:
    ...
    @pytest.mark.asyncio
    async def test_get_all_jobs_returns_list(self):
        job = make_job_entity()
        db = make_db_mock()
    ...
    @pytest.mark.asyncio
    async def test_get_all_jobs_empty(self):
        db = make_db_mock()
        mock_result = MagicMock()
        mock_result.scalars.return_value.all.return_value = []
        db.execute.return_value = mock_result
