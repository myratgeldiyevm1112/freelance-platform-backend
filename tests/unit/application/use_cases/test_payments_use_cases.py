...
@pytest.mark.asyncio
async def test_create_payment_contract_not_found():
    client = make_client()
    payment_repo = AsyncMock()
    contract_repo = AsyncMock()
...
@pytest.mark.asyncio
async def test_create_payment_forbidden_not_client():
    client = make_client()
...
@pytest.mark.asyncio
async def test_create_payment_calls_stripe():
    client = make_client()
    freelancer = make_freelancer()
    contract = make_contract(client.id, freelancer.id)
    payment = make_payment(contract.id, client.id, freelancer.id)
...
@pytest.mark.asyncio
async def test_refund_payment_forbidden():
    client = make_client()
    other_client = make_client()
    freelancer = make_freelancer()
    contract_id = uuid.uuid4()
...
@pytest.mark.asyncio
async def test_refund_payment_not_escrowed():
    client = make_client()
    freelancer = make_freelancer()
    contract_id = uuid.uuid4()
...
@pytest.mark.asyncio
async def test_refund_skips_stripe_if_no_intent_id():
    client = make_client()
    freelancer = make_freelancer()
    contract_id = uuid.uuid4()
    payment = make_payment(contract_id, client.id, freelancer.id)
...
@pytest.mark.asyncio
async def test_release_payment_not_found():
    client = make_client()
    payment_repo = AsyncMock()
    payment_repo.get_by_contract_id.return_value = None
...
@pytest.mark.asyncio
async def test_release_payment_forbidden():
    client = make_client()
    other_client = make_client()
    freelancer = make_freelancer()
    contract_id = uuid.uuid4()
...
@pytest.mark.asyncio
async def test_release_payment_not_escrowed():
    client = make_client()
    freelancer = make_freelancer()
    contract_id = uuid.uuid4()
    payment = make_payment(contract_id, client.id, freelancer.id, status=PaymentStatus.RELEASED)
...
@pytest.mark.asyncio
async def test_release_payment_already_refunded():
    client = make_client()
    freelancer = make_freelancer()
    contract_id = uuid.uuid4()
